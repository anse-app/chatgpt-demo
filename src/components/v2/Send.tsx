...
const EmptyState = () => (
  <div class="fixed bottom-0 left-0 right-0 h-14 px-6 border-t border-base flex flex-row items-center gap-2 transition-colors cursor-pointer hover:bg-darker">

...
2. 选择要部署的分支，选择`feat/netlify`， 在项目设置中配置环境变量，环境变量配置参考下文。

![image](https://cdn.staticaly.com/gh/yzh990918/static@master/20230310/image.1ilum2vel7j4.webp)

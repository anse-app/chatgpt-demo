...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-back-bottom-btn': 'fcc p-2.5 text-base rounded-md hover:bg-slate/10 fixed bottom-20px right-60px z-10 cursor-pointer transition-colors transform-rotate-180deg',
